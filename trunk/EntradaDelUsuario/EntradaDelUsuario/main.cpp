...
//    Práctica 1: Entrada del Usuario
//-----------------------------------------
//En líneas generales, se implementa un gestor de entrada (InputManager) que se encarga
// de actualizar y leer los dispositivos de entrada. Se implementan 3 clases (cKeyBoard, cPad y
// cMouse) que representan el teclado el gamepad y el ratón y se encargan de encapsular los
// eventos producidos por dichos dispositivos.
//Para probar la aplicación, se ha programado que ésta debe cerrarse con la tecla Escape del teclado,
// el botón central del mouse o el botón 1 del gamepad.
